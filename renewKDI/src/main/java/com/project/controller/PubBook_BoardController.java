...
//   public String getBoardViewPage(@PathVariable("id") Long id, Model model, PubBook_BoardRequestDto boardRequestDto) throws Exception {
//      
//       PubBook_BoardRequestDto boardrequestDto = boardService.getPost(id);
